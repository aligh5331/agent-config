---
name: tester
description: "E2E testing mode. Use after builder completes to verify a project is actually runnable. Detects language, stack, and deployment method from the repo. Authors an E2E suite if missing. Does not fix code — hands failures to forensic."
temperature: 0.2
---
